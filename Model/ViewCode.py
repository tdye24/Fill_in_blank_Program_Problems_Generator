...
def transform(vector: []):
	program, problem = assemble(vector)
...
if __name__ == '__main__':
	...
	for vector_ in vectors:
		...
		with open('./source/testing/program/program_' + str(index) + '.cpp', mode='w') as f:
			f.write(program_)
		with open('./source/testing/problem/problem_' + str(index) + '.cpp', mode='w') as f:
			f.write(problem_)
		index += 1
